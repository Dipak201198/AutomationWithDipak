...
public class AssetCreationGxP 
{
	...
	public void f() throws Exception {
		...
		File src1 = new File("D:\\Selenium Excel\\Asset Induction\\INT Asset Uploader Batch 3 by Andrew.xlsx");
...
*/
			...
			WebElement systemelement = driver.findElement(By.xpath("//input[@id='fld4101037']")); // System Element checked
			systemelement.click();
			Thread.sleep(4000);
/*
			WebElement systemelementunchecked = driver.findElement(By.xpath("//input[@id='fld4101037']")); // System Element Unchecked
			systemelementunchecked.click();
			Thread.sleep(4000);
*/		
			...
			driver.switchTo().frame("childmain"); Thread.sleep(2000);
			 
			 WebElement action=driver.findElement(By.xpath("//*[@id='menuBar1_Menu1']"));
			 action.click(); Thread.sleep(6000);
			 
			 WebElement statuschange=driver.findElement(By.linkText("Change Status"));
			 statuschange.click(); Thread.sleep(2000);
			 
			 driver.switchTo().frame("STATUSCHANGE"); Thread.sleep(2000);
