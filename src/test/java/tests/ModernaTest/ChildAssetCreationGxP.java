...
public class ChildAssetCreationGxP 
{
	@Test
	public void f() throws Exception {
		
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\dHolkarshinde\\Downloads\\chromedriver-win32\\chromedriver-win32\\chromedriver.exe");
...
//		WebDriver driver = new ChromeDriver(chromeOptions);
		...
		passw.sendKeys("mRNAmed@2024");
		Thread.sleep(2000);
		WebElement loginbtn = driver.findElement(By.id("lblButtonbtnLogin"));
		loginbtn.click();
		Thread.sleep(10000);

		File src1 = new File("D:\\Selenium Excel\\AssetGxP.xlsx");
		...
		for (int i = 1; i < rowcountt; i++) {
			...
			WebElement ramresponsibility = driver.findElement(By.xpath("//input[@id='fld4101028']")); // RAM Responsibility																						
			...
			String P99 = sheet1.getRow(i).getCell(7).getStringCellValue();
...
*/			
			...
			String P13 = sheet1.getRow(i).getCell(14).getStringCellValue();
