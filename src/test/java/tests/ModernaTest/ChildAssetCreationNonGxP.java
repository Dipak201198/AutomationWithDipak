...
public class ChildAssetCreationNonGxP {
	...
	public void f() throws Exception {
		...
		File src1 = new File("C:\\Selenium Excel\\Remaining 30 GxP Asset.xlsx");
		...
		for (int i = 1; i < rowcountt; i++) {
			...
			WebElement rulename = driver.findElement(By.id("fld4101058"));
			rulename.clear();
...
//			cell.setCellValue(assetid);
			...
			String P2 = sheet1.getRow(i).getCell(8).getStringCellValue();
			...
			String P5 = sheet1.getRow(i).getCell(9).getStringCellValue();
			WebElement desc = driver.findElement(By.xpath("//*[@id='fld4101010']")); // Asset Description
			desc.sendKeys(P5);
			Thread.sleep(2000);

			String P6 = sheet1.getRow(i).getCell(3).getStringCellValue();
			...
			String P10 = sheet1.getRow(i).getCell(10).getStringCellValue();
			WebElement assettype = driver.findElement(By.xpath("//input[@id='fld4101030']")); // Asset Type
			assettype.click();
			assettype.sendKeys(P10);
			Thread.sleep(4000);

			String P9 = sheet1.getRow(i).getCell(4).getStringCellValue();
			WebElement department = driver.findElement(By.xpath("//input[@id='fld4101008']")); // Department
			department.click();
			department.sendKeys(P9);
			Thread.sleep(4000);
			/*
			 * String P99 = sheet1.getRow(i).getCell(7).getStringCellValue(); WebElement
			 * parentsysname = driver.findElement(By.xpath("//input[@id='fld4101024']")); //
			 * Parent System Name parentsysname.click(); parentsysname.sendKeys(P99);
			 * Thread.sleep(2000);
			 */

			String P122 = sheet1.getRow(i).getCell(19).getStringCellValue();
			WebElement impact = driver.findElement(By.xpath("//input[@id='fld4101209']")); // Impact
			impact.click();
			impact.sendKeys(P122);
			Thread.sleep(2000);

			String P14 = sheet1.getRow(i).getCell(16).getStringCellValue();
			WebElement snumber = driver.findElement(By.xpath("//input[@id='fld4101016']")); // Serial Number
			snumber.click();
			snumber.sendKeys(P14);
			Thread.sleep(4000);

			String P8 = sheet1.getRow(i).getCell(5).getStringCellValue();
			WebElement assetowner = driver.findElement(By.xpath("//input[@id='fld4101009']")); // Asset Owner
			assetowner.click();
			assetowner.sendKeys(P8);
			Thread.sleep(4000);

			WebElement systemelement = driver.findElement(By.xpath("//input[@id='fld4101037']")); // System Element Checkbox
			systemelement.click();
			Thread.sleep(4000);

			String P11 = sheet1.getRow(i).getCell(18).getStringCellValue();
			WebElement classification = driver.findElement(By.xpath("//input[@id='fld4101018']")); // Classification
			classification.click();
			classification.sendKeys(P11);
			Thread.sleep(4000);

			String P12 = sheet1.getRow(i).getCell(14).getStringCellValue();
			WebElement manufacturer = driver.findElement(By.xpath("//input[@id='fld4101012']")); // Manufacturer
			manufacturer.click();
			manufacturer.sendKeys(P12);
			Thread.sleep(4000);

			String P128 = sheet1.getRow(i).getCell(1).getStringCellValue();
			WebElement comments = driver.findElement(By.xpath("//*[@id='fld4101043']")); // Comments
			comments.sendKeys(P128);
			Thread.sleep(2000);

			String P13 = sheet1.getRow(i).getCell(15).getStringCellValue();
			...
			String P123 = sheet1.getRow(i).getCell(11).getStringCellValue();
			...
			String P124 = sheet1.getRow(i).getCell(12).getStringCellValue();
			...
			String P125 = sheet1.getRow(i).getCell(13).getStringCellValue();
